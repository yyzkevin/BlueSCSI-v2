	...
	int sixByteCmd, int dbd, int pc, int pageCode, int allocLength)
{
	...
	if(1==2) { //as400
		...
		if(!sixByteCmd) {				
			...
			scsiDev.target->sense.asc = 0x2000; // Invalid Command Operation
			scsiDev.phase = STATUS;
			return;
		}
		*/
		const uint8_t as400[]={};
	
		memcpy(scsiDev.data,as400,0x8C);
		scsiDev.dataLen = 0x8C;		
